...
/**
* <p>
* 车队是相对于外部承运商车队来说，可以理解为公司自营的车队,一个租户下数据状态为10的车队编码只能有一个VO
* </p>
*
* @author system
* @since 2025-04-20
...
@Schema(name = "TruckFleetInnerVO", description = "车队是相对于外部承运商车队来说，可以理解为公司自营的车队,一个租户下数据状态为10的车队编码只能有一个VO")
public class TruckFleetInnerVO implements Serializable {
